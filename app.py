...
def ollama_suggestion(code: str):
    try:
        prompt = f"""You are a code reviewer. Given the Python code below, return exactly 3–5 suggestions (1 line each).
- DO NOT explain what you are doing, and dont display any thing about prompt only return suggestions"""
